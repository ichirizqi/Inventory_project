...
<div class="d-flex flex-row justify-content-between">
    <h1 class="h3 mb-2 text-gray-800 mb-5">Tambah Barang</h1>
</div>
...
<div class="card shadow mb-4">
    ...
    <form method="POST" action="{{ route('barang.store') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{ old('qty') }}" placeholder="Masukkan Stok Barang">
